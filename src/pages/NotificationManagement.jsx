...
import { createNotification, fetchNotifications, deleteNotification, fetchUsersBySearch } from "../utils/api";
          ...
          <ul className="list-group">
            {notifications.map(notif => (
              <li key={notif.id} className="list-group-item d-flex justify-content-between">
                ...
                <button className="btn btn-sm btn-outline-primary" onClick={() => handleDelete(notif.id)}>
                  Inactive
                </button>
              </li>
            ))}
